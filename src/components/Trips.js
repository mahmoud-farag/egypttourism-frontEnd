            ...
            {email === "mahmoud@gmail.com" && (
              <div className="tripsCard">
                <Card>
                  <CardBody>
                    <Form>
                      <Label for="exampleFile" className="labelColor">
                        إختر صورة
                      </Label>
                      <Input type="file" name="file" id="exampleFile" />

                      <Label for="exampleText" className="labelColor">
                        اسم الرحلة
                      </Label>
                      <Input
                        type="text"
                      ...
                      <Label for="exampleDate" className="labelColor">
                        تاريخ الرحلة
                      </Label>
                      <Input
                        type="date"
                      ...
                      <Label for="exampleNumber" className="labelColor">
                        سعر الرحلة
                      </Label>
                      <Input
                        type="number"
                      ...
                      <Col xs="6">
                        {" "}
                        <Button color="primary">إنشر</Button>{" "}
                      </Col>
                    </Form>
                  </CardBody>
                </Card>
